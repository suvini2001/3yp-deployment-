    ...
    <DayPicker
      ...
      components={{
        Chevron: ({ orientation, className }) => {
          ...
          if (orientation === "up") return <ChevronLeft className={cn("h-4 w-4 rotate-90", className)} />;
          if (orientation === "down") return <ChevronLeft className={cn("h-4 w-4 -rotate-90", className)} />;
